...
void   compute_shared_slacks(DOC **docs, long *label, double *a, 
			     double *lin, double *c, long *active2dnum, 
...
long   select_next_qp_subproblem_rand(long *, long *, double *, 
				      ...
				      long *, double *, long *, KERNEL_CACHE *,
				      long *, long *, long);
long   select_next_qp_slackset(DOC **docs, long *label, double *a, 
